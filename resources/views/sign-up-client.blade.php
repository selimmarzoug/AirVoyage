    ...
    <link rel="stylesheet" href="/css01/css/style.css">
      <style>
        ...
        .alert-danger {
            ...
            border-color: #f5c6cb;
            padding-top: 8px; /* Adjust the padding top */
            padding-bottom: 8px; /* Adjust the padding bottom */
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="{{ route('registerClient') }}" method="post" autocomplete="off" class="sign-in-form" id="/css01-form">
                            @if (session('success'))
...
<option value="Zimbabwe">Zimbabwe </option>
    ...
    @enderror
                            ...
                            <div class="form-group">
                            <label for="num_passeport"><i class="zmdi zmdi-label"></i></label>
                            <input type="text" name="num_passeport" id="num_passeport" placeholder="Your Passport Number" value="{{ old('num_passeport') }}">
                            @error('num_passeport')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            </div>
                    ...
                    <div class="signup-image">
                        <figure><img src="/css01/images/signup-image.jpg" alt="sing up image"></figure>
    ...
    <style>
        /* Styles spécifiques pour l'élément <select> */
#pays {
    width: 100%;
    display: block;
    border: none;
